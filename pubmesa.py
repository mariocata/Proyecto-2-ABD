...
def main():
    conn = psycopg2.connect(host = 'localhost', user= 'postgres', password ='123456', dbname= 'Feria')
    cursor = conn.cursor()
    ...
    while(True):
        conn = psycopg2.connect(host = 'localhost', user= 'postgres', password ='123456', dbname= 'Accesos')
        cursor = conn.cursor()
